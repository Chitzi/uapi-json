...
var request_original = '';
var response_original = '';
...
module.exports = function (settings) {
  ...
  returnFn.searchLowFares = function() {
      var ret = uApiRequest(
      ...
      request_original = ret.request;
      response_original = ret.response;
      return ret.results;
  };
  returnFn.availability = uApiRequest(
    config.AirService.url,
    auth,
  ...
  returnFn.lookupFareRules = uApiRequest(
    config.AirService.url,
    auth,
    templates.price,
    'air:AirPriceRsp',
  ...
  returnFn.airPricePricingSolutionXML = uApiRequest(
    config.AirService.url,
    auth,
    templates.price,
  ...
  returnFn.createReservation = uApiRequest(
    config.AirService.url,
    auth,
  ...
  returnFn.getUniversalRecordByPNR = uApiRequest(
  ...
  returnFn.getUniversalRecord = uApiRequest(
    config.UniversalRecord.url,
    auth,
  ...
  returnFn.flightInfo = uApiRequest(
  ...
  returnFn.getTicket = uApiRequest(
    config.AirService.url,
    auth,
  ...
  returnFn.getTickets = uApiRequest(
    config.AirService.url,
    auth,
    templates.retrieveDocument,
    'air:AirRetrieveDocumentRsp',
  ...
  returnFn.cancelTicket = uApiRequest(
    config.AirService.url,
    auth,
  ...
  returnFn.cancelPNR = uApiRequest(
    config.AirService.url,
    auth,
    templates.cancel,
